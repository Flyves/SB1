...
public class Constants {
    ...
    public static final double BALL_INERTIA = 0.4 * BALL_MASS * Constants.BALL_RADIUS * Constants.BALL_RADIUS;
    public static final Matrix3By3 BALL_MOMENT_OF_INERTIA_TENSOR = Matrix3By3.UNIT.scaled(BALL_INERTIA);
    ...
    public static final double CAR_MAX_SPIN = 5.5;
    public static final double CAR_MASS = 180;
    public static final Matrix3By3 CAR_MOMENT_OF_INERTIA_TENSOR = Matrix3By3.unitOf(new Vector3(1 / 36.07956616966136, 1 / 12.14599781908070, 1 / 8.91962804287785));
