...
/**
 * This class represents a function of the turn radius of a rocket league car with respect to its speed.
 */

public abstract class TurnRadius {
    ...
    /**
     *  Get the turn radius from the car speed.
    ...
    /**
     *  Get the speed from the car's turn radius.
