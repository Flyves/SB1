package util.rocket_league.game_situation.situations.ball_hit_on_car;
...
public class BallHitOnCar2 extends GameSituation {
    ...
    public BallHitOnCar2() {
        super(new FrameTimer(5*(int) Constants.BOT_REFRESH_RATE));
    }
    ...
    public void loadGameState() {
        ...
        Vector3 ballPosition = Vector3.Z_VECTOR.scaled(1000)
                ...
                .rotate(Vector3.Z_VECTOR.scaled(1))
                .plus(carPosition);
